...
#         personal_account.incoming_transfer(100.0)
...
#         personal_account = PersonalAccount("Bob", "Smith", "12345654321")
#         personal_account.outgoing_transfer(30.0)
#         assert personal_account.balance == 0.0

#         company_account = CompanyAccount("Nazwa", "12345654321")
#         company_account.outgoing_transfer(30.0)
#         assert company_account.balance == 0.0

#     def test_transfer_insufficient_funds2(self):
#         personal_account = PersonalAccount("Bob", "Smith", "12345654321")
...
#         personal_account.outgoing_express_transfer(10.0)
...
#         account.outgoing_express_transfer(10.0)
#         assert account.balance == -5.0

#     def test_express_transfer_insufficient_funds_message(self):
#         personal_account = PersonalAccount("Alice", "Kowalski", "61010112345")
#         personal_account.balance = 5.0
#         result = personal_account.outgoing_express_transfer(10.0)
...
#         personal_account = PersonalAccount("Alice", "Kowalski", "61010112345")
#         personal_account.balance = 10.0
#         result = personal_account.outgoing_express_transfer(-5.0)
...
#         personal_account.outgoing_express_transfer(50)
...
#     def test_histor_transfer(self):
#         account = PersonalAccount("Jan", "Kowalski", "70010112345")
#         account.balance = 100.0
#         account.outgoing_transfer(50.0)
#         assert account.historia == [-50.0]

#     def test_history_company_transfer(self):
